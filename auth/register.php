        ...
        <form action="register.php" method="post"
            ...
            <div class="flex flex-col gap-5 mt-2">
                <button type="submit" name="registrasi"
                    class="w-full bg-gradient-to-r from-blue-600 via-rose-600 to-red-600 bg-[size:200%_auto] hover:bg-right text-white font-bold py-3.5 px-4 rounded-2xl shadow-xl shadow-red-600/20 active:scale-[0.97] transition-all duration-500 text-sm cursor-pointer text-center tracking-wide">
                    Daftar Sekarang
                </button>
